								...
								<div className="col-lg-9 col-md-8 col-sm-8 col-xs-12">
									<div className="col-md-6">
										<div className="form-group">
											...
											<span className="input-group-addon"><i className="ion-ios-people-outline"></i></span>
									...
									<div className="col-lg-6">
										<div className="form-group">
											...
											<span className="input-group-addon"><i className="ion-android-contact"></i></span>
							...
							{recordcount ?
								<div><div className="">
									...
									{datailInfo ?
										...
										: ''}
								</div> : <div className="no-data-center"><img src="images/business.png" /><p>Start searching for people...</p></div>}
						</div>
					</div>
				</section>
			</div>
