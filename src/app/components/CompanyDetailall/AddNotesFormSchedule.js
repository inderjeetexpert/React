...
class AddNotesFormSchedule extends React.Component {
	constructor(props) {
		super(props)
	}
		...
		return (
			...
			<div>
				<div className="activity-box-body">
					...
					<textarea placeholder="Start typing to leave a schedule"></textarea>
				</div>
				<div className="activity-box-footer">
					<div className="pull-left">
						{/*<a><img src="images/attachment.svg" /></a>
						<a><img src="images/link-1.svg" /></a>*/}
						<button className="btn btn-ancient">Add Contacts</button>
					</div>
...
export default AddNotesFormSchedule;
