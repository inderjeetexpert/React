        ...
        <Widget>
          ...
          <WidgetContent>
            <BootstrapTable data={table.data} options={this.options} hover bordered={false}>
              <TableHeaderColumn width='75%' dataSort dataField={table.dataFeild1} dataFormat={dataFormat} isKey>{table.header1}</TableHeaderColumn>
              <TableHeaderColumn width='25%' dataSort dataField={table.dataFeild2} dataAlign='right'>{table.header2}</TableHeaderColumn>
            </BootstrapTable>
